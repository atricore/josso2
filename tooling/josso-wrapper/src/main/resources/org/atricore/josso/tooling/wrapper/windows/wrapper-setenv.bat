...
set wrapper_jar="%wrapper_home%/lib/wrapper/wrapper.jar"
...
set conf_file="%wrapper_home%/etc/${name}-wrapper.conf"

rem default configuration used in genConfig
set conf_default_file="%wrapper_home%/etc/${name}-wrapper.conf.default"
